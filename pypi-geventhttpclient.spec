...
Source0  : https://files.pythonhosted.org/packages/eb/92/4e150971654512baf70749d2730feed3bfd37e8c1710adb8d8323e9583f5/geventhttpclient-2.0.12.tar.gz
...
%prep
%setup -q -n geventhttpclient-2.0.12
cd %{_builddir}/geventhttpclient-2.0.12
pushd ..
cp -a geventhttpclient-2.0.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710539647
