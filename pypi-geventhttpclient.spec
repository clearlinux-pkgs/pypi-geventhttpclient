...
Source0  : https://files.pythonhosted.org/packages/8c/14/d4eddae757de44985718a9e38d9e6f2a923d764ed97d0f1cbc1a8aa2b0ef/geventhttpclient-2.3.1.tar.gz
...
%prep
%setup -q -n geventhttpclient-2.3.1
cd %{_builddir}/geventhttpclient-2.3.1
pushd ..
cp -a geventhttpclient-2.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730166786
