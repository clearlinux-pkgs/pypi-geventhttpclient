...
Source0  : https://files.pythonhosted.org/packages/89/19/1ca8de73dcc0596d3df01be299e940d7fc3bccbeb6f62bb8dd2d427a3a50/geventhttpclient-2.3.4.tar.gz
...
%prep
%setup -q -n geventhttpclient-2.3.4
cd %{_builddir}/geventhttpclient-2.3.4
pushd ..
cp -a geventhttpclient-2.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749650068
