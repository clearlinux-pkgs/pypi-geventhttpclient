...
Source0  : https://files.pythonhosted.org/packages/68/98/1ee9fbab4ae97d5f0f05035059a56a61a9c966331e6c837f974b402fdf63/geventhttpclient-2.0.2.tar.gz
...
%prep
%setup -q -n geventhttpclient-2.0.2
cd %{_builddir}/geventhttpclient-2.0.2
pushd ..
cp -a geventhttpclient-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661967036
